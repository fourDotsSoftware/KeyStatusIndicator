...
;copy translations end
  ...
  !define MUI_FILE "KeyStatusIndicator"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Key Status Indicator 4dots"
  !define PRODUCT_SHORTCUT "Key Status Indicator 4dots"
  !define PRODUCT_VERSION "1.7"
  
  !define MUI_ICON "key-status-indicator-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  Name "Key Status Indicator 4dots"
  OutFile "KeyStatusIndicatorSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Key Status Indicator 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Key Status Indicator 4dots - User's Manual.url.lnk" "$INSTDIR\Key Status Indicator 4dots - User's Manual.url" "" "$INSTDIR\Key Status Indicator 4dots - User's Manual.url" 0
...
;Add files
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Key Status Indicator 4dots - User's Manual.url";
  File "ddb.dat"
  File "4dots Software Product CATALOG.url"
  File "license_agreement.rtf"                       
 
	File "KeyPressedScroll.exe"
	File "KeyPressedNum.exe"
	File "KeyPressedIns.exe"
	File "KeyPressedCaps.exe"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Key Status Indicator 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Key Status Indicator 4dots" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Key Status Indicator 4dots"
  DeleteRegKey HKCU "Software\4dots Software\Key Status Indicator 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/key-status-indicator/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OptionsPage
  ...
  ReadINIStr $R2 "$PLUGINSDIR\NSISAdditionalActionsPage.ini" "Field 2" "State"
  ReadINIStr $R3 "$PLUGINSDIR\NSISAdditionalActionsPage.ini" "Field 3" "State"
  ReadINIStr $R4 "$PLUGINSDIR\NSISAdditionalActionsPage.ini" "Field 4" "State"  
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/key-status-indicator/how-to-use.php?afterinstall=true"
FunctionEnd
